...
export default function ButtonRotatingGradient({
  ...
  return (
    <div className="relative inline-block">
      <button  type="button"
        onClick={onClick} className="relative cursor-pointer inline-flex md:h-20 h-16 overflow-hidden rounded-full p-0.75 focus:outline-none">
